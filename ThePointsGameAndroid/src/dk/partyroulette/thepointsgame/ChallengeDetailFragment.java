 ...
 * This fragment is either contained in a {@link ChallengeListActivity}
 * in two-pane mode (on tablets) or a {@link ChallengeDetailActivity}
 * on handsets.
 */
public class ChallengeDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.challenge_detail)).setText(mItem.getDescription());
        }
